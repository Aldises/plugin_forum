...
*/
	...
	//	Until you edit this function, nobody is ever logged in
		...
		//echo 'session id: '.$sessionid_moodle;
			...
			//echo ' user id: '.$userid_moodle;
			
			$result=mysql_fetch_assoc(
				mysql_query(
					"SELECT username, email FROM mdl_user WHERE id=".$userid_moodle,
					$qa_db_connection
				)
			);
...
*/
	...
	//	Until you edit this function, always return null
        ...
        if (count($publicusernames)) {
            ...
            $results=mysql_query(
                'SELECT username, id FROM mdl_user WHERE username IN ('.implode(',', $escapedusernames).')',
                $qa_db_connection
            );
...
*/
	...
	//	Until you edit this function, always return null
        ...
        if (count($userids)) {
            ...
            $results=mysql_query(
                'SELECT username, id FROM mdl_user WHERE id IN ('.implode(',', $escapeduserids).')',
                $qa_db_connection
            );
